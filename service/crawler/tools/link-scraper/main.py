...
class WebsiteCrawler:
    ...
    def _extract_links(self, url):
        ...
        try:
            ...
            nav_containers = [
                'nav', '.primary-menu-wrapper', '.header-navigation-wrapper', 
                '.mobile-menu', '.menu-modal', '.menu-wrapper', '.menu-top',
                '.modal-menu', '.header-inner', '.header-titles-wrapper',
                '.footer-nav-widgets-wrapper', '#site-header', '#site-footer'
            ]
            ...
            nav_classes = ['menu-item', 'primary-menu', 'header-navigation', 'mobile-menu', 'menu-modal']
            for tag in soup.find_all('a', href=True):
